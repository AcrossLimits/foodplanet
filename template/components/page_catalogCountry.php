<div id="catalog_Country" style="display: none;">
    <div class="leaderTableWrapper fade-in one">
                        <table class="leaderTable" id="catalogTable2" cellspacing="0" cellpadding="0">
                            <?php 
                                $type = "even";
                                $count = 0;
                                foreach($catalog_country as $cat) :
                                $count++;
                                if($type == "even")
                                    $type = "odd";
                                else
                            ...
                            ?>
                            <tr class="<?php echo $type; ?>" id="itemC_<?php echo $cat->itemID; ?>">
                                <td class="left">
