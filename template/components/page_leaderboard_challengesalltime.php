<div id="leaderboard_challengesalltime" style="display: none;">
    <div class="leaderTableWrapper fade-in one">
                        <table class="leaderTable" id="leaderTable4" cellspacing="0" cellpadding="0">
                            <?php 
                                $type = "even";
                                $count = 0;
                                foreach($leaders_challengesalltime as $leader) :
                                $count++;
                                if($type == "even")
                                    $type = "odd";
                                else
