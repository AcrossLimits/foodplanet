<div id="leaderboard_challengesweek" style="display: none;">
    <div class="leaderTableWrapper fade-in one">
                        <table class="leaderTable" id="leaderTable3" cellspacing="0" cellpadding="0">
                            <?php 
                                $type = "even";
                                $count = 0;
                                foreach($leaders_challengesweek as $leader) :
                                $count++;
                                if($type == "even")
                                    $type = "odd";
                                else
