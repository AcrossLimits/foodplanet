...
<div id="dialogBadgeUnlocked">
    ...
    <div class="wrapper" id="dialogBadgeUnlockedWrapper">
        <div class="title" data-localize="_badges._tounlock">To unlock this badge</div>
...
<script>
    ...
    document.getElementById('dialogBadgeDimiss').onclick = function () { dismissInformation(); };
