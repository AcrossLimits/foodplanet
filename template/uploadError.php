    ...
    <body>
         ...
         <div id="header">
            ...
            <div class="button" id="menuButton">&nbsp;</div>
                    ...
                    <div id="pageWrapper">
                        <div id="uploadImage"><img src="img/imgUploadError.png" class="fade-in one"/></div>
                        <div class="upper fade-in two">Upload failed!</div>
                        <div class="middle fade-in two">Please try again later</div>
                    </div>
